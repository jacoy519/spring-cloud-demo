...
public class AbstractSpiderTaskService {
    ...
    private final static Logger logger = Logger.getLogger(AbstractSpiderTaskService.class);
    ...
    private void execTask(String taskType, String taskJob) {
        ThreadPoolTaskExecutor executorPool = getThreadPool(taskJob);
